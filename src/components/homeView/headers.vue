                ...
                <nav class="l-nav_tenpo">
                                    ...
                                    <div class="l-buy_inner lazyload">
                                        <div class="l-buy_2nd lazyload">
                                            ...
                                            <dl class="l-buy_2nd_list list-map">
                                                <dt>地図から探す</dt>
                                                <dd><a
                                                        href="area_map/">地図から物件を探す</a>
                                                </dd>
                                                <dd><a
                                                        href="mansion_map/">マンションカタログ</a>
                                                </dd>
                                                <dd><a
                                                        href="villa_map/">別荘地カタログ</a>
                                                </dd>
                                            </dl>
                                    ...
                                    <div class="l-rentVer02_inner lazyload">
                                        <div class="l-rentVer02_2nd lazyload">
                                            <dl class="l-rentVer02_2nd_list list-type">
                                                <dt>種別から探す</dt>
                                                <dd><a class="type-mansion"
                                                        href="estate_list_karuizawa/rent/?kind_code=1">アパート・マンション</a>
                                                </dd>
                                                <dd><a class="type-house"
                                                        href="estate_list_karuizawa/rent/?kind_code=2">戸建・テラスハウス</a>
                                                </dd>
                                                <dd><a class="type-parking"
                                                        href="estate_list_karuizawa/rent/?kind_code=3">駐車場</a>
                                                </dd>
                                                <dd><a class="type-investment"
                                                        href="estate_list_karuizawa/rent/?kind_code=4">事業用</a>
                                                </dd>
                                            </dl>
                                            <dl class="l-rentVer02_2nd_list list-map">
                                                <dt>地図から探す</dt>
                                                <dd><a
                                                        href="area_map_rent/">地図から物件を探す</a>
                                                </dd>
                                                <dd><a
                                                        href="mansion_map/">マンションカタログ</a>
                                                </dd>
                                            ...
                                            <dl class="l-rentVer02_2nd_list list-other">
                                                ...
                                                <dd><a class="type-season"
                                                        href="estate_list_karuizawa/rent/?kind_code[]=1&amp;kind_code[]=2&amp;kodawari[]=117">シーズン貸し</a>
                                                </dd>
                                                <dd><a href="">条件から探す</a></dd>
                                                <dd class="c-textSearch">
                                                    <form
                                    ...
                                    <div class="l-lend_inner lazyload">
                                        ...
                                        <div class="l-lend_3rd lazyload">
                                            <dl class="l-lend_3rd_list list-main">
                                                ...
                                                <dd><a
                                                        href="sellproperty/owner1/">ロイヤルが選ばれる理由</a>
                                                </dd>
                                                <dd><a
                                                        href="lend/agreementflowrent/">賃貸経営の流れ</a>
                                                </dd>
                    ...
                    <div class="l-nav_tenpoInner areaSelect lazyload">
                        <nav class="l-nav_mobile">
                            <ul itemtype="https://www.schema.org/SiteNavigationElement" class="l-nav_menu">
                                <li itemprop="name" class=""><a href="" itemprop="url" class="-active">熱海・湯河原</a>
                                </li>
                                <li itemprop="name" class=""><a href="" itemprop="url">伊東・伊豆高原</a></li>
                                <li itemprop="name" class=""><a href="" itemprop="url">箱根</a></li>
                                <li itemprop="name" class=""><a href="" itemprop="url">軽井沢</a></li>
                            </ul>
                        </nav>
                    </div>
